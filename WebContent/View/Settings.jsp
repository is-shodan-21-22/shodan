			...
			<div class="settings-container">
				<div class="set-info">
					...
					<form onsubmit="return false;" class="psw-form">
						...
						<input id="settings-input-old-password" type="password" placeholder="Password attuale">
						<input id="settings-input-new-password" type="password" placeholder="Nuova password">
						<input id="settings-input-new-password-again" type="password" placeholder="Ripeti la password">
					...
					<form onsubmit="return false;" class="email-form">
						...
						<input id="settings-input-email" type="email" value="${user.email}">
